...
public class ToolSwordSargart extends ItemAxe implements IHasMod {
    public ToolSwordSargart(String name, ToolMaterial materual) {
        super(materual, 24F, -3.6F);
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        try {
            tooltip.add(Config.swordSargartinfo_1);
            ...
            if (stack.getEnchantmentTagList().tagCount() == 0) {
                ...
                stack.addEnchantment(Enchantment.getEnchantmentByID(16), 8);
