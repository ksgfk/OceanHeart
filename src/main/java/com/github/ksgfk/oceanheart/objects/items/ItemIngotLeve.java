...
public class ItemIngotLeve extends Item implements IHasMod {

    public ItemIngotLeve(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, ITooltipFlag advanced) {
        tooltip.add(TextFormatting.RED + I18n.format("tooltip." + getUnlocalizedName(stack) + ".desc"));
    }
}
