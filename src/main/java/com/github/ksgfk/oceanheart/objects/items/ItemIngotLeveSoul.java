...
public class ItemIngotLeveSoul extends Item implements IHasMod {
    public ItemIngotLeveSoul(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(TextFormatting.RED + I18n.translateToLocal("tooltip." + getUnlocalizedName(stack) + ".desc"));
    }
}
