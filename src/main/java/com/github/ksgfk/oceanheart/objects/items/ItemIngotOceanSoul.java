...
public class ItemIngotOceanSoul extends Item implements IHasMod {
    public ItemIngotOceanSoul(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(TextFormatting.BLUE + I18n.translateToLocal("tooltip." + getUnlocalizedName(stack) + ".desc"));
    }
}
