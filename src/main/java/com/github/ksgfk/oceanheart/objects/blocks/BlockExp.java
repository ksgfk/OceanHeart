...
public class BlockExp extends Block implements IHasMod {

    public BlockExp(String name, Material material) {
        super(material);
    ...
    public void registerModels() {
        ...
        //OceanHeart.proxy.registerVariantRenderer(Item.getItemFromBlock(this), 0, "inventory", "exp");
    }
}
